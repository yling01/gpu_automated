...
echo "Enter the sequence with lowercase letter indicating L-aa and uppercase letter indicating D-aa: "
read sequence
...
do
    ...
    echo 13 | gmx_mpi genion -s ion.tpr -p cx_rsff2_tip3p.top -o ion.gro -neutral &> genion.log
